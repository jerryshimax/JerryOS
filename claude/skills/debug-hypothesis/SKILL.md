...
1. Everything gets written to `DEBUG.md`. Context compaction will eat your
   ...
   **DEBUG.md location:** For ShipOS projects, write to `~/Ship/[entity]/[project]/DEBUG.md`.
   Otherwise, the current working directory is fine.
...
- Never touch `~/.claude/` or any `CLAUDE.md` file during debugging.
- Never run destructive shell commands (`rm -rf`, `DROP TABLE`, force-push) as part of an experiment.
